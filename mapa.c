...
void bye(){
	...
	printf("--------------------------------------\n");
	printf("       _         _                   \n");
	printf("  __ _| |_ ___  | | ___   __ _  ___  \n");
	printf(" / _` | __/ _ \\ | |/ _ \\ / _` |/ _ \\ \n");
	printf("| (_| | ||  __/ | | (_) | (_| | (_) |\n");
	printf(" \\__,_|\\__\\___| |_|\\___/ \\__, |\\___/ \n");
	printf("                         |___/       \n");
	printf("--------------------------------------\n");
}
...
void retira_senha(){
	...
	if (validar() == 1) {
		...
		printf("--------------------------------------\n");
		printf("                _  \n");          
		printf(" ___  ___ _ __ | |__   __ _ \n");
		printf("/ __|/ _ \\ '_ \\| '_ \\ / _` |\n");
		printf("\\__ \\  __/ | | | | | | (_| |\n");
		printf("|___/\\___|_| |_|_| |_|\\__,_|\n");
...
void logo(){
	...
	printf("     ''''  ''''\n");
	printf("   _                                    \n");
	printf("  /_\\   ___ ___  _   _  __ _ _   _  ___ \n");
	printf(" //_\\\\ / __/ _ \\| | | |/ _` | | | |/ _ \\\n");
	printf("/  _  \\ (_| (_) | |_| | (_| | |_| |  __/\n");
	printf("\\_/ \\_/\\___\\___/ \\__,_|\\__, |\\__,_|\\___|\n");
	printf("                       |___/            \n");
	printf("                   __                   \n");
	printf(" ___  ___ _   _    \\ \\  ___  ___  ___   \n");
	printf("/ __|/ _ \\ | | |    \\ \\/ _ \\/ __|/ _ \\  \n");
	printf("\\__ \\  __/ |_| | /\\_/ / (_) \\__ \\  __/\n");
	printf("|___/\\___|\\__,_| \\___/ \\___/|___/\\___|  \n");
}
...
void painel(){
	...
	printf("--------------------------------------\n");
	printf("             _            _ \n");
	printf(" _ __   __ _(_)_ __   ___| |\n");
	printf("| '_ \\ / _` | | '_ \\ / _ \\ |\n");
	printf("| |_) | (_| | | | | |  __/ |\n");
	printf("| .__/ \\__,_|_|_| |_|\\___|_|\n");
	printf("|_|\n");
	printf("--------------------------------------\n");
